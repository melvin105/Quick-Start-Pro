...
export default function NextOfKinSection({ register, control, errors }: PublicFormSectionProps) {
  return (
    <div className="flex flex-col gap-4">
      <h2 className="text-[13px] font-semibold text-gray-500 uppercase tracking-wide">Next of Kin</h2>
