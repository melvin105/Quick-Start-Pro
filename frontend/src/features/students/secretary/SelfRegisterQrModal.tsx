...
// A static, permanent link — no token to mint, so nothing to load. No phone
// is bound to it, so a single printed poster serves every walk-in; unlike the
// old per-open token it never expires, so it never needs reprinting.
