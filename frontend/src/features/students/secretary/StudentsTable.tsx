...
import { getInitials, formatGHS, studentProfilePath, studentEditPath } from '../shared/utils'
          ...
          <tbody>
            {students.map((student) => (
              ...
              >
                ...
                <td className="px-4 py-3 text-[13px] text-gray-900 whitespace-nowrap">{formatGHS(student.balance)}</td>
                ...
                <td className="px-4 py-3">
                  <div className="flex items-center gap-1">
                    ...
                    <button
                      type="button"
                      onClick={(e) => { e.stopPropagation(); navigate(studentEditPath(student.id)) }}
                      className="p-1.5 rounded-md text-gray-400 hover:text-brand-600 hover:bg-brand-50 transition-colors"
